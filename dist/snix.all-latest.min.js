...
// Snix.Ajax
// --------------------------------
(function(){var e=function(e){return{success:function(t,n){return e.success(_.bind(t,n||this)),this},error:function(t,n){return e.error(_.bind(t,n||this)),this}}};Snix.get=function(t){var n=$.ajax({type:"GET",url:t});return e(n)},Snix.post=function(t,n,r){var n=JSON.stringify(n?n:{}),i=$.ajax({type:"POST",url:t,data:r?{data:n}:n,dataType:"json"});return e(i)},Snix.put=function(t,n){var n=JSON.stringify(n?n:{}),r=$.ajax({type:"POST",url:t,data:{data:n,_method:"PUT"},dataType:"json"});return e(r)},Snix.patch=function(t,n){var n=JSON.stringify(n?n:{}),r=$.ajax({type:"POST",url:t,data:{data:n,_method:"PATCH"},dataType:"json"});return e(r)},Snix.delete=function(t,n){var r=$.ajax({type:"POST",url:t,data:{_method:"DELETE"}});return e(r)}})();Snix.record=function(e){var t=Snix.val();return t.newRecord=function(){t(new e)},t.find=function(n){var r=e.find(n);r.subcribe(function(e){t(e)})},t},Snix.Record=function(e,t){var n={},r=function(r,i){this.id=s.val(),this.canCreate=s.compute(function(){return this.id()==null},this),this.canSave=s.compute(function(){return this.id()!=null},this),this.canDelete=s.compute(function(){return this.id()!=null},this),this.url=s.compute(function(){return(i!=null?i.url():"")+e+"/"+this.id()},this),this.urlCreate=s.compute(function(){return(i!=null?i.url():"")+e},this);var o={create:[],save:[],"delete":[]};this.on=function(e,t,n){o[e].push(_.bind(t,n||this))};var u=_.keys(t);this.delete=function(){var e=$.ajax({type:"POST",url:this.url(),data:{_method:"DELETE"}}).success(function(){_.invoke(o["delete"],"call",null)}).error(function(e){alert(e)});return this},this.save=function(){var e=JSON.stringify(_.pick(this,u)),t=$.ajax({type:"POST",url:this.url(),data:{data:e,_method:"PUT"},dataType:"json"}).success(function(){_.invoke(o.save,"call",null)}).error(function(e){alert(e)});return this},this.create=function(){var e=this,t=JSON.stringify(_.pick(this,u)),n=$.ajax({type:"POST",url:url,data:t,dataType:"json"}).success(function(t){e.id(t.id),_.invoke(o.create,"call",null)},this).error(function(e){alert(e)});return this},r=r||{},r.id&&this.id(r.id);for(var a in t){var f=t[a],l=r[a]===undefined?f[1]:r[a];l!=null&&f[2]&&(l=f[2].apply(l,[l])),this[a]=f[0](l)}for(var a in n){var c=n[a];this[a]=s.array();var h=this;this[a].load=function(){return s.get(h.url()+c.baseUrl).success(function(e){h[a](_.map(e,function(e){return new c(e,h)}))},this).error(function(e){alert("err: "+e)}),this},this[a].reload=function(){return this([]),this.load()}}};return r.all=function(t){var n=s.array();return n.load=function(){var t=this;return s.get(e).success(function(e){t(_.map(e,function(e){return new r(e)}))}).error(function(e){alert("err: "+e)}),this},n.reload=function(){return this([]),this.load()},t||n.load(),n},r.find=function(t){var n=s.val();return n.load=function(){var t=this;return s.get(e).success(function(e){t(new r(e))}).error(function(e){alert("err: "+e)}),this},n.reload=function(){return this(null),this.load()},n.load(),n},r.hasMany=function(e,t){n[e]=t},r.baseUrl=e,r};